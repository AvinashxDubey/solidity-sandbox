...
contract ERC1155 is IERC1155 {
    ...
    function safeTransferFrom(address from, address to, uint256 id, uint256 amount, bytes calldata data) external {
        require(to!=address(0), "Invalid transfer to 0 Address!!");
        ...
        if(to.code.length>0){
            require(
                ...
                "Unsafe Transfer to Non ERC1155Receiver!!"
            );
        }
    }
    ...
    function _batchMint(
        ...
        if(to.code.length>0){
            require(
                ...
                "Unsafe Transfer to Non ERC1155BatchReceiver"
            );
        }
    }

    function _burn(address from, uint256 id, uint256 value) internal {
        require(from!=address(0), "Invalid Transfer from 0 Address!!");
...
contract Token1155_impl is ERC1155 {
    ...
    modifier onlyOwner {
        require(msg.sender==owner, "Unauthorised Action!!");
        _;
    }
